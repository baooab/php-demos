...
function do_html_header($title = '') {
  ...
  $isAdminCatalog = strpos($_SERVER['PHP_SELF'], '/admin') ? true  : false;
...
?>
  ...
  ?>
      <a href="../index.php">
        <img src="../images/Book-O-Rama.gif" alt="Bookorama" border="0"align="left" valign="bottom" height="55" width="325"/>
      </a>
  <?php
    else :
  ?>
    ...
    if (@file_exists("images/".$book['isbn'].".jpg"))  {
      ...
      if(($size[0] > 0) && ($size[1] > 0)) {
        echo "<td><img src=\"images/".$book['isbn'].".jpg\"
              style=\"border: 1px solid black;width: 120px;\"/></td>";
      }
    }
    echo "<td><ul>";
...
function display_button($target, $image, $alt) {
    echo "<div align=\"center\"><a href=\"".$target."\">
        <img src=\"" . get_image_path($image) .".gif\"
